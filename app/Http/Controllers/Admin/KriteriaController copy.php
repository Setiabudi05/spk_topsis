...
class KriteriaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.kriteria.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'sertifikat' => 'required',
            'kemampuan' => 'required',
            'penggunaan_teknologi' => 'required',
            'penggunaan_tools' => 'required',
            'infrakstruktur' => 'required',
        ]);
        ...
        try {
            ...
            $this->kriteriaRepo->updateOrCreate($user, $validatedData);
            DB::commit();
            Alert::success('User Kriteria has been created!');
            return redirect(route('admin.kriteria.index'));
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
            Alert::error("User Kriteria failed to create!");
            return back();
        }
    }
    ...
    public function update(Request $request, string $enc_id)
    {
        ...
        DB::beginTransaction();
        try {
            $this->kriteriaRepo->updateOrCreate(['user_id' => Crypt::decrypt($enc_id)], $validatedData);
            DB::commit();
            Alert::success('User Kriteria has been updated!');
            return redirect(route('admin.kriteria.index'));
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
            Alert::error("User Kriteria failed to update!");
            return back();
        }
    }
