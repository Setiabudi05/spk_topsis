                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.user.store') }}" method="POST" data-parsley-validate>
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                <label for="name-column" class="form-label">Name</label>
                                                <input type="text" id="name-column" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="email" id="email-column" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="password-column" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password"
                                                       value="{{ old('password') }}" data-parsley-required="true" />
                                            </div>
                                            @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="confirm_password-column" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password"
                                                       placeholder="Confirm Password" value="{{ old('confirm_password') }}" data-parsley-required="true" />
                                            </div>
