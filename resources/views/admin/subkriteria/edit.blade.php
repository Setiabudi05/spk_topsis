                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.subkriteria.update', Crypt::encrypt($subkriterias->id)) }}" method="POST" data-parsley-validate>
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                <label for="kriteria-column" class="form-label">Kriteria</label>
                                                <input type="text" id="kriteria-column" class="form-control" value="({{ $subkriterias->kriteria->kode }}) {{ $subkriterias->kriteria->nama }}"
                                                       disabled />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="nama-column" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Nama"
                                                       value="{{ $subkriterias->nama }}" data-parsley-required="true" />
                                            </div>
                                            @error('nama')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="nilai-column" class="form-control @error('nilai') is-invalid @enderror" name="nilai" placeholder="Nilai"
                                                       value="{{ $subkriterias->nilai }}" data-parsley-required="true" />
                                            </div>
                                            @error('nilai')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
