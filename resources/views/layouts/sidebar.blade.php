        ...
        <ul class="menu">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link text-danger btn btn-outline-danger" onclick="event.preventDefault(); this.closest('form').submit();">
            ...
            <li class="sidebar-item {{ request()->segment(2) === 'subkriteria' ? 'active' : '' }}">
                <a href="{{ route('admin.subkriteria.index') }}" class="sidebar-link">
                    <i class="bi bi-grid-fill"></i>
                    <span>Data Sub Kriteria</span>
                </a>
            </li>
            <li class="sidebar-item {{ request()->segment(2) === 'alternatif' ? 'active' : '' }}">
                <a href="{{ route('admin.alternatif.index') }}" class="sidebar-link">
                    <i class="bi bi-grid-fill"></i>
                    <span>Data Alternatif</span>
                </a>
            </li>
            <li class="sidebar-item {{ request()->segment(2) === 'penilaian' ? 'active' : '' }}">
            ...
            <li class="sidebar-item {{ request()->segment(2) === 'hasil-kriteria' ? 'active' : '' }}">
                <a href="{{ route('admin.hasil_kriteria.show') }}" class="sidebar-link">
                    <i class="bi bi-grid-fill"></i>
                    <span>Hasil Akhir</span>
                </a>
            </li>

            <li class="sidebar-title">Daftar User</li>
